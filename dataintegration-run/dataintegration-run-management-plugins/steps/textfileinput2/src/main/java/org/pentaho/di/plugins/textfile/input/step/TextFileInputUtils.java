...
public class TextFileInputUtils {
  ...
  public static final String[] guessStringsFromLine(VariableSpace space, LogChannelInterface log, String line,
                                                    TextFileInputMeta2 inf, String delimiter, String enclosure, String escapeCharacter ) throws KettleException {
  ...
  public static final TextFileLine getLine(LogChannelInterface log, InputStreamReader reader, EncodingType encodingType,
    ...
    boolean lenientEnclosureHandling = ValueMetaBase.convertStringToBoolean(
      Const.NVL( EnvUtil.getSystemProperty( "KETTLE_COMPATIBILITY_TEXT_FILE_INPUT_USE_LENIENT_ENCLOSURE_HANDLING" ), "N" ) );
  ...
  public static final String getLine( LogChannelInterface log, InputStreamReader reader, EncodingType encodingType,
    ...
    try {
      switch ( formatNr ) {
        case TextFileInputMeta2.FILE_FORMAT_DOS:
          while ( c >= 0 ) {
            c = reader.read();
          ...
          break;
        case TextFileInputMeta2.FILE_FORMAT_UNIX:
          while ( c >= 0 ) {
            c = reader.read();
          ...
          break;
        case TextFileInputMeta2.FILE_FORMAT_MIXED:
  ...
  public static final Object[] convertLineToRow(LogChannelInterface log, TextFileLine textFileLine,
                                                TextFileInputMeta2 info, Object[] passThruFields, int nrPassThruFields, RowMetaInterface outputRowMeta,
  ...
  public static final String[] convertLineToStrings( LogChannelInterface log, String line, TextFileInputMeta2 inf,
