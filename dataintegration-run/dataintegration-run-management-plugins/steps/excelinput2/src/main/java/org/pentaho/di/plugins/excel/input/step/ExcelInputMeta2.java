...
package org.pentaho.di.plugins.excel.input.step;
...
public class ExcelInputMeta2 extends BaseStepMeta implements StepMetaInterface {
  private static Class<?> PKG = ExcelInputMeta2.class; // for i18n purposes, needed by Translator2!!
  ...
  @Override
  public Object clone() {
    ExcelInputMeta2 retval = (ExcelInputMeta2) super.clone();
    normilizeAllocation();
